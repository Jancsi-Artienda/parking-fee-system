      ...
      <div className="w-full p-3 md:p-6 pt-14 md:pt-6 rounded-2xl shadow-lg bg-white">
        ...
        <div className="flex w-full mt-4">
          <button
            ...
            disabled={loading}
            className="w-full sm:w-auto sm:ml-auto px-5 py-2 text-sm text-white font-medium rounded-xl bg-[#1a3a5c] hoverbg-[#1a3a5c] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Print
          </button>
        </div>
